      ...
      <div className="bg-sv-surface border border-sv-border rounded-2xl p-8 shadow-2xl space-y-6">
        <div className="space-y-1">
          ...
          <p className="text-sm text-sv-text-muted">
            {step === 1 && 'Fill in your details to start using SONIVAULT.'}
        ...
        {step === 1 && (
          <form onSubmit={handleSendOtp} className="space-y-4">
            <div className="space-y-1.5">
              <label htmlFor="register-name" className="block text-sm font-medium text-sv-text-secondary">
                Full Name
              </label>
              <div className="relative">
                <User className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-sv-text-muted pointer-events-none" />
                <input
                  id="register-name"
                  type="text"
                  value={name}
            ...
            <div className="space-y-1.5">
              <label htmlFor="register-email" className="block text-sm font-medium text-sv-text-secondary">
                Email address
              </label>
              <div className="relative">
        ...
        {step === 2 && (
          <form onSubmit={handleVerifyOtp} className="space-y-4 animate-fade-in">
            <div className="space-y-1.5">
              <label htmlFor="register-otp" className="block text-sm font-medium text-sv-text-secondary">
                6-digit Code
              </label>
              <input
                id="register-otp"
